...
const servicesData = [
  { icon: <FaTruck />, name: "Express Delivery", description: "Fast and reliable delivery within 24 hours for urgent packages.", link: "/services/express-delivery" },
  { icon: <FaBoxOpen />, name: "Parcel Packaging", description: "Secure packaging solutions for fragile and valuable items.", link: "/services/parcel-packaging" },
  { icon: <FaShippingFast />, name: "Same Day Delivery", description: "Get your parcels delivered on the same day to local destinations.", link: "/services/same-day-delivery" },
  { icon: <FaWarehouse />, name: "Warehousing", description: "Safe storage for your goods with inventory management.", link: "/services/warehousing" },
  { icon: <FaMapMarkedAlt />, name: "Route Optimization", description: "Efficient delivery routes to save time and cost.", link: "/services/route-optimization" },
  { icon: <FaClipboardList />, name: "Order Tracking", description: "Real-time tracking of your shipment from dispatch to delivery.", link: "/services/order-tracking" },
];
  ...
  return (
    <section className="py-20 bg-gray-50 dark:bg-gray-900">
      <div className="max-w-7xl mx-auto px-6 md:px-12 text-center">
        ...
        >
          {(startLoading ? services.length > 0 ? services : Array(6).fill({}) : Array(6).fill({})).map((service, index) => (
            <motion.div
              key={index}
