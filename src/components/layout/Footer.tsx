...
const Footer = () => {
    return (
        <footer className="">
            <div className="container mx-auto max-w-screen-xl px-4 pt-16 pb-6 sm:px-6 lg:px-8 lg:pt-24">
                <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
                    <div>
                        ...
                        <p className="mt-6 max-w-md text-center leading-relaxed text-foreground sm:max-w-xs sm:text-left">
                            Delivering with care, on time, every time.
                        </p>
                ...
                <div className="mt-12 border-t border-gray-100 pt-6">
                    <div className="text-center sm:flex sm:justify-between sm:text-left">
                        <p className="text-sm text-foreground">
                            ...
                            <a
                                className="inline-block text-foreground underline transition hover:text-foreground/75"
                                href="#"
                            >
                                Terms & Conditions
                            </a>
                        ...
                        <p className="mt-4 text-sm text-foreground sm:order-first sm:mt-0">
